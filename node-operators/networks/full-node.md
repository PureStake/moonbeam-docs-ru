...
### Порты по умолчанию для полноценной Parachain ноды
...
### Порты по умолчанию встроенной цепи передачи
...
## Журналирование и устранение неполадок
