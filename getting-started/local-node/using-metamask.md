...
![Импортируйте учетную запись разработчика](/images/tokens/connect/metamask/metamask-3.png)
...
![Вставьте ключ от вашего аккаунта в MetaMask](/images/tokens/connect/metamask/metamask-4.png)

У Вас должен получиться импортированный «Account 2», который выглядит следующим образом:

![MetaMask отображает ваш новый Account 2](/images/tokens/connect/metamask/metamask-5.png)
...
![Введите информацию о вашей новой сети в MetaMask](/images/legacy/metamask/using-metamask-4.png)
...
![Баланс вашей учтеонй записи Moonbeam 1207925.8196](/images/legacy/metamask/using-metamask-5.png)
...
![Инициализация перевода токенов](/images/tokens/connect/metamask/metamask-9.png)
...
![Подтверждение транзакции](/images/tokens/connect/metamask/metamask-10.png)
...
![Новый баланс “Account 1](/images/tokens/connect/metamask/metamask-11.png)
...
![Нода Moonbeam](/images/tokens/connect/metamask/metamask-12.png)
