---
Заголовок: Настройка ноды
Описание: Воспользуйтесь данным руководством, для настройки своего первого узла Moonbeam. Вы также узнаете, как его подключить и управлять с помощью пользовательского графического интерфейса Polkadot JS.
---
