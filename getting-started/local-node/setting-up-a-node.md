...
Следуя данной инструкции от начала и до конца, Вы получите узел разработки Moonbeam, работающий в Вашей локальной среде, с 10-ю [pre-funded accounts](#pre-funded-development-accounts),и сможет подключить его к стандартному графическому интерфейсу Polkadot JS.
