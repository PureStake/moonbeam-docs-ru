...
Следуя данной инструкции от начала и до конца, Вы получите узел разработки Moonbeam, работающий в Вашей локальной среде, с 10-ю [предварительно профинансированные счета разработки](#pre-funded-development-accounts), и сможете подключить его к стандартному графическому интерфейсу Polkadot JS.
